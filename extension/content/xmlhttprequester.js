function wikipediaspoilerhider_xmlhttpRequester(unsafeContentWin, chromeWindow) {
...
wikipediaspoilerhider_xmlhttpRequester.prototype.contentStartRequest = function(details) {
	...
	switch (scheme) {
		...
		case "ftp":
			this.chromeWindow.setTimeout(
				wikipediaspoilerhider_gmCompiler.hitch(this, "chromeStartRequest", url, details), 0);
			break;
		default:
...
wikipediaspoilerhider_xmlhttpRequester.prototype.chromeStartRequest=function(safeUrl, details) {
...
wikipediaspoilerhider_xmlhttpRequester.prototype.setupRequestEvent =
